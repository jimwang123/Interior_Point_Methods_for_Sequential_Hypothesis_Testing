...
def process_files(data1, data2, mu_0, alphas, iters):
    ...
    ops_tau, ops_tpr = ops_experiment(data1, mu_0, alphas, iters)
    _, ops_fpr = ops_experiment(data2, mu_0, alphas, iters)
...
def call_process_oj23(data1, data2, mu_0, alphas, iters, output_file=None):
...
if __name__ == "__main__":
    ...
    call_process_oj23(data1, data2, mu_0, alphas, iters, output_file)