...
import math
import numpy as np
from methods_optftrl_barrier import betting_experiment
...
def call_process_optftrl(data1, data2, data3, data4, alphas, iters, output_file=None):
...
if __name__ == "__main__":
    ...
    call_process_optftrl(data1, data2, data3, data4, alphas, iters, output_file)