...
import math
import numpy as np
from methods_oj23 import ops_experiment
...
def process_files(data1, data2, data3, data4, alphas, iters):
    ...
    ops_tau, ops_tpr = ops_experiment(data1, data2, alphas, iters)
    _, ops_fpr = ops_experiment(data3, data4, alphas, iters)
...
def call_process_oj23(data1, data2, data3, data4, alphas, iters, output_file=None):
...
if __name__ == "__main__":
    ...
    call_process_oj23(data1, data2, data3, data4, alphas, iters, output_file)