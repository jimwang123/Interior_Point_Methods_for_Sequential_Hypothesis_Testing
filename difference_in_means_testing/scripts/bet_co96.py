...
import math
import numpy as np
from methods_co96 import ops_experiment
...
def call_process_co96(data1, data2, data3, data4, alphas, iters, output_file=None):
...
if __name__ == "__main__":
    ...
    call_process_co96(data1, data2, data3, data4, alphas, iters, output_file)