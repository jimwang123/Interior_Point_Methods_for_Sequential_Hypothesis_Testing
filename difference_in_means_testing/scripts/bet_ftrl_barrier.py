...
import math
import numpy as np
from methods_ftrl_barrier import betting_experiment
...
def call_process_ftrl(data1, data2, data3, data4, alphas, iters, output_file=None):
...
if __name__ == "__main__":
    ...
    call_process_ftrl(data1, data2, data3, data4, alphas, iters, output_file)